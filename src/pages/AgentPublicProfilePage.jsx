...
const styles = {
  ...
  agentName: { fontFamily: 'Inter, sans-serif', fontWeight: 800, fontSize: 22, color: 'var(--text-1)', marginBottom: 4 },
  ...
  statValue: { fontFamily: 'Inter, sans-serif', fontWeight: 800, fontSize: 22, color: 'var(--gold-text)', marginBottom: 3 },
  ...
  sectionTitle: { fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: 16, color: 'var(--text-1)', marginBottom: 16 },
  ...
  jobTitle: { fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: 14, color: 'var(--text-1)', marginBottom: 2 },
